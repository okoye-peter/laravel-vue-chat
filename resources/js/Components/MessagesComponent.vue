<template>
    <div class="content h-screen" v-show="friendId != 0">
        <div class="messages">
            <ul>
                <li v-for="(chat, index) in getActiveUserChats(friendId)" :key="index"
                    :class="[chat.user_id == friendId ? 'sent' : 'replies', chat.type == 1 ? 'image' : '']">
            ...
            <div class="preview_wrapper">
                <div class="preview_container">
                    ...
                    <div class="flex justify-around">
                        <button class="bg-red-500 hover:bg-red-600 px-5 py-2" @click="hideImagePreview"><i
                                class="fas fa-times"></i></button>
                        <button class="bg-green-500 hover:bg-green-600 px-5 py-2" @click="sendImage"><i
